<template>
  <div class="detail_container">
    ...
    <div class="group-buying">
      ...
      <div class="footer">
        <div @click="collectRemark">
          <img :src="isCollect?'/static/images/collect-active.png':'/static/images/collect.png'" /> 收藏
        </div>
        <div>
