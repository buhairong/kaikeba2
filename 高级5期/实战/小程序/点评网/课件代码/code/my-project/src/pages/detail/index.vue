  ...
  <div class="detail_container">
    <div class="container_up">
      <div class="detail_content">
        <div class="imgContainer">
          <img
            v-if="detailData.image_path"
            :src="'cloud://dianping-830xs.6469-dianping-830xs-1300966336/'+detailData.image_path"
          />
        </div>
        <ul>
          <li class="store_title">{{detailData.title}}</li>
          <li class="store_price">
            <Star :score="detailData.score"></Star>
            {{detailData.view}}条 ￥{{detailData.price}}/人
          </li>
          <li
            class="store_taste"
          >口味：{{detailData.score}} 环境：{{detailData.environment}} 服务：{{detailData.service}}</li>
          <li class="store_type">{{detailData.description}}</li>
        </ul>
      </div>
      <div class="local">
    ...
    <div class="group-buying">
      ...
      <div class="more-container">
        查看其他4个团购
        <span class="more-arrows"></span>
      </div>
      <div class="footer">
        <div @click="collect(detailData.id)">
          <img :src="isCollection?'/static/images/collect-active.png':'/static/images/collect.png'" /> 收藏
        </div>
        <div>
          <img src="/static/images/remark.png" /> 写点评
        </div>
      </div>
    </div>
  </div>
